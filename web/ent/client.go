...
import (
	...
	"github.com/Pineapple217/Sortify/web/ent/migrate"
...
// QueryTracks queries the tracks edge of a Playlist.
func (c *PlaylistClient) QueryTracks(pl *Playlist) *TrackQuery {
...
// QueryPlaylists queries the playlists edge of a Track.
func (c *TrackClient) QueryPlaylists(t *Track) *PlaylistQuery {
...
type (
	hooks struct {
		Playlist, Session, Track, User []ent.Hook
	}
	inters struct {
		Playlist, Session, Track, User []ent.Interceptor
	}
)
