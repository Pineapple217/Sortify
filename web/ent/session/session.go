...
var Columns = []string{
	...
	FieldLastLoginAt,
	FieldCreatedAt,
	FieldSpotifyAccessToken,
	FieldSpotifyRefreshToken,
	FieldSpotifyExpiry,
}
...
func BySpotifyAccessToken(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSpotifyAccessToken, opts...).ToFunc()
}
