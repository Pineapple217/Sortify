...
func init() {
	...
	playlistMixinHooks0 := playlistMixin[0].Hooks()
	playlist.Hooks[0] = playlistMixinHooks0[0]
	playlistMixinInters0 := playlistMixin[0].Interceptors()
	playlist.Interceptors[0] = playlistMixinInters0[0]
